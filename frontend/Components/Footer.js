            ...
            <div className="grid grid-cols-12" >
                    ...
                    <div className="col-start-4 col-span-6 w-full items-center grid grid-rows-2">
                         ...
                         <nav className="row-span-1 flex flex-row justify-evenly items-center w-full">
                            <label className=" px-3 body-regular whitespace-nowrap">Privacy Policy</label>
                            <label className=" px-3 body-regular whitespace-nowrap">Terms &Services</label>
                            <label className=" px-3 body-regular whitespace-nowrap">About us</label>
                            <label className=" px-3 body-regular whitespace-nowrap">Contact us</label>
                         </nav> 
