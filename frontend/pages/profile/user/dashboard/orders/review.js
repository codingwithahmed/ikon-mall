...

                    {
                        ...
                        <EmpytyState desc={'Looks like you haven’t made your choice yet. Let’s shop!'} img={'/profile/user/placeholder/6.png'} heading={'Your order is empty'} >
                            ...
                            <div className="flex flex-row  items-center justify-start">
                                ...
                                <Link href={'/profile/user/dashboard/orders/completed'}><p className="text-slate-300 flex-1 order-dashboard-order-text cursor-pointer hover:text-slate-900 hover:underline transition-all">Completed</p></Link>
                                <Link href={'/profile/user/dashboard/orders/review'}><p className="underline text-slate-900 flex-1 order-dashboard-order-text cursor-pointer hover:text-slate-900 hover:underline transition-all">Reviews</p></Link>  
                            </div>
