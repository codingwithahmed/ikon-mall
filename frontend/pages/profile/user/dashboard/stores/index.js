            ...
            <div className="col-span-4 flex-col flex  ">
                            <div className="box-shadow-dashboard-sidebar p-4 rounded-[32px]">
                                ...
                                <div className="flex flex-col mt-8 px-8">
                                        ...
                                        <SidebarItem address={'stores'} active={true} text={'Connected Stores'} img={'/profile/user/dashbaord/3.svg'} />
                        ...
                        <div className="col-span-8 px-8 relative flex flex-col" >
                                <div className="my-4">
                                    <h4 className="heading4">Connected Stores</h4>
                                </div>
...

                    {
                        ...
                        <EmpytyState desc={'Looks like you haven’t connected any stores yet. Let’s explore!'} img={'/profile/user/placeholder/9.png'} heading={'No Connected Stores '} >
                                <PrimaryButton>
                                    Connect With Stores
                                </PrimaryButton>
                        </EmpytyState>
