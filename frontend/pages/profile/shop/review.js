                        ...
                        <div className="flex flex-col w-full gap-8 mt-4">
                            ...
                            <div className="my-4">
                                <div className="flex flex-row">
                                    <h3 className="text-orange-400 review-heading ">4.9</h3>
                                    <p className="ml-4 mt-2 review-input-heading ">Overall rating (150)</p>
                                </div>

                                <div className="flex flex-row mt-2 items-center">
                                <img src="/common/star.svg" className="mr-1 w-[24px]" />
                                <img src="/common/star.svg" className="mx-1 w-[24px]" />
                                <img src="/common/star.svg" className="mx-1 w-[24px]" />
                                <img src="/common/star.svg" className="mx-1 w-[24px]" />
                                <img src="/star2.png" className="mx-1 w-[24px]" />
                                </div>
                            </div>  
